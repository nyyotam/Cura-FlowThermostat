...
##
		...
		if getValue(line, 'G', None) == 1: #do this for all individual lines with G1 in them
                        ...
                        if pastStart == 0:
                                ...
                                #print feedCurrent
                                if getValue(line, 'E', 0) > 0 and feedCurrent != lastFeedCurrent and feedCurrent <= feedFull : #if we are on an extruding line with changed feed speed
